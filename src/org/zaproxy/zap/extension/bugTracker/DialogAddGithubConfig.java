...
class DialogAddGithubConfig extends AbstractFormDialog {
    ...
    private static final String PASSWORD_FIELD_LABEL = Constant.messages.getString("bugTracker.trackers.github.dialog.config.field.label.name");
    private static final String REPO_URL_FIELD_LABEL = Constant.messages.getString("bugTracker.trackers.github.dialog.config.field.label.name");
